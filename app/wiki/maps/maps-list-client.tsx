    ...
    return (
        <div className="space-y-8 pb-12">
            ...
            <div className="relative overflow-hidden rounded-2xl border border-border/60 bg-gradient-to-br from-slate-900 via-slate-900 to-slate-950 p-6 sm:p-8 shadow-2xl">
                ...
                <div className="pointer-events-none absolute -top-12 right-0 h-48 w-48 rounded-full bg-blue-500/10 blur-[80px]" />
                        ...
                        <div className="flex-1">
                            <div className="flex items-center gap-2 flex-wrap">
                                ...
                                <Badge className="bg-blue-500/20 text-blue-400 border-blue-500/30 text-xs">
                                    {wikiMaps.length} Maps
                                </Badge>
                            </div>
                            <p className="text-sm text-slate-400 mt-1">
                                Detailed breakdowns across {theaters.length} theaters of war with strategies and control points
                            </p>
                        </div>
                    </div>
                </div>
