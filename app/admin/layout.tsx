        ...
        <div className="flex min-h-screen flex-col md:flex-row">
            <aside className="w-full md:w-64 bg-secondary/30 border-r border-border p-4">
                ...
                <nav className="space-y-2">
                    ...
                    <Link href="/admin/claimed-servers" className="flex items-center gap-2 px-4 py-2 rounded-md hover:bg-secondary transition-colors">
                    ...
                    <div className="h-px bg-border my-2" />
                    <Link href="/admin/integrity" className="flex items-center gap-2 px-4 py-2 rounded-md hover:bg-secondary transition-colors">
                        <Shield className="h-4 w-4" />
                        Integrity Dashboard
                    </Link>
                    <Link href="/admin/review-queue" className="flex items-center gap-2 px-4 py-2 rounded-md hover:bg-secondary transition-colors">
