                    ...
                    <Card className="border-[#1e2a14] bg-[#070b05] overflow-hidden">
                        ...
                        <CardContent className="p-6 space-y-10">
                                ...
                                <div className="space-y-4">
                                    <div className="p-4 rounded-lg border border-[#1e2a14] bg-[#0a0f06]">
                                        ...
                                        <p className="text-sm mt-2">
                                            A <strong>keyhash</strong> is a one-way cryptographic hash of a player&apos;s game CD key, generated by the Battlefield 1942 engine itself before transmission. We never receive or store the underlying CD key — only the hash. Keyhashes serve solely as a consistent, anonymous player identifier to link rounds and statistics across sessions.
                                        </p>
                                    </div>
                                    ...
                                    <div className="p-4 rounded-lg border border-[#1e2a14] bg-[#0a0f06]">
                                        ...
                                        <p className="text-sm mt-2">
                                            Login is handled exclusively through <strong>Discord OAuth 2.0</strong>. We never store passwords or OAuth access tokens. After authentication, a secure session token is issued and stored in a server-side session (via an encrypted cookie) to keep you logged in. If you disconnect your Discord account from our Service, your session is invalidated and your linked account data is removed. Any remaining game statistics associated with your profile become unlinked but are not automatically deleted.
                                        </p>
                                    </div>
                            ...
                            <Section id="gdpr" icon={Globe} title="Your Rights (GDPR)">
                                ...
                                <p>
                                    If you believe your rights have not been adequately addressed, you have the right to lodge a complaint with your local supervisory authority. In the EU, this is typically your national Data Protection Authority (DPA). A full list of EU DPAs is maintained by the European Data Protection Board at <strong>edpb.europa.eu</strong>. UK residents may contact the Information Commissioner&apos;s Office (ICO) at <strong>ico.org.uk</strong>.
                                </p>
                            </Section>
